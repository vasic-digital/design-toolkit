...
`constitution/CLAUDE.md` in the heading above is the **canonical name of the base
...
not turn the heading into one: an `@constitution/CLAUDE.md` import resolves
...
This carrier is read by Claude Code (claude.ai/code).
